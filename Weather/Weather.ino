//Select ESP#@ Dev module from boards manager
// pinout here https://jensd.dk/edu/doc/esp32/ttgo-t-pins.jpg
//Weather api here https://home.openweathermap.org/api_keys
//donot use library for tft from arduino. USe from here https://github.com/Xinyuan-LilyGO/TTGO-T-Display
//product bought from here https://www.amazon.com/dp/B099MPFJ9M?psc=1&ref=ppx_yo2_dt_b_product_details
//source for the code here https://www.reddit.com/r/diyelectronics/comments/kg4jv7/here_is_internet_weather_station_i_created_for_my/
//
#include "ani.h"
#include <SPI.h>
...
//const char* ssid     = "Pixel_9689";       ///EDIIIT
//const char* password = "dodododo"; //EDI8IT
const char* ssid     = "Mans 2.4";       ///EDIIIT
const char* password = "Dawgdaze"; //EDI8IT
String town="Seattle";              //EDDIT
String Country="US";                //EDDIT
const String endpoint = "http://api.openweathermap.org/data/2.5/weather?q="+town+","+Country+"&units=metric&APPID=";
const String key = "36f13aa0ef856a8c2061398d1f8744ba"; /*EDDITTTTTTTTTTTTTTTTTTTTTTTT                      */
